...
import SamGeneration from './SamGeneration'
      ...
      <div class="content container py-5" style={{ height: "25rem"}} >
          ...
          <div class="page-header page-header-light page-header-reset py-3">
            <div class="row align-items-center">
              <div class="col">
                <h1 class="page-header-title">Production Planner Operation Bulliten</h1>
              </div>
              <div class="col-auto">
              <Link to='/app.knitwear' class='btn btn-primary'>Go Back</Link>
